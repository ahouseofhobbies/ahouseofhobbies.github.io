    ...
    effects: [
      {
        ...
        In addition, for each friendly unit you pick, give your opponent 1 temptation dice. During this battle round, instead of making a wound roll, save roll, ward roll or run roll, your opponent can use 1 temptation dice to replace the roll they would have made with a 6, or they can use 2 temptation dice to replace 2 of the dice in a charge roll with two 6's (other dice could then be rolled normally). Rolls that have been replaced count as unmodified rolls and cannot be rerolled. You cannot use temptation dice to replace a reroll. 
