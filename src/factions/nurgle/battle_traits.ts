  ...
  [NURGLE]: {
    effects: [
      ...
      },
      {
        ...
        desc: `Effect: If an ability would heal or return slain models to a Diseased enemy unit, that ability does not heal any damage points or return any slain models to it. Instead, it no longer has the Diseased keyword. Manifestations and faction terrain features cannot be given the Diseased keyword by any friendly abilities.`,
        when: [DURING_GAME],
      },
      {
